...
OUTPUT_DIR = "/Users/eguchiyuuichi/projects/voicenotea/docs/tablet_7inch_screenshots"

# 7インチタブレットの標準解像度 (9:16 縦向き)
TABLET_WIDTH = 1080
TABLET_HEIGHT = 1920
...
def main():
    """メイン処理"""
    print("=" * 60)
    print("7インチタブレット用スクリーンショット生成ツール")
    print("=" * 60)
    print(f"入力ディレクトリ: {MOBILE_SCREENSHOTS_DIR}")
    print(f"出力ディレクトリ: {OUTPUT_DIR}")
    print(f"ターゲット解像度: {TABLET_WIDTH}x{TABLET_HEIGHT} (16:9)")
    print("=" * 60)
    ...
    for filename in MOBILE_SCREENSHOTS:
        ...
        output_filename = f"{base_name}_tablet.jpg"
